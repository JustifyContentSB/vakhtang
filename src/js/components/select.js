...
export default class extends Component {
    constructor(...args) {
        ...
        const attrs = ['id', 'default', 'root', 'element', 'input', 'dropdown', 'item', 'value', 'checkbox', 'label'];
    ...
    init() {
        const { getId, buildLayout, bindMethods } = this;
    ...
    buildLayout(el) {
        const { attrs, disable, getId, getElements, getDefaults, renderItems } = this;
