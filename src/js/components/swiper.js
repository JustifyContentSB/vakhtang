...
export default class extends Component {
    ...
    buildLayout = (el) => {
        ...
        $(el).append(
            '<div class="swiper-navigation"><div class="swiper-controls"><a class="swiper-control swiper-control--prev"></a><a class="swiper-control swiper-control--next"></a></div><div class="swiper-pagination"></div></div>',
        );
    };
    ...
    setup = (el, options) => {
        const { getId, getParams, buildLayout } = this;
